...
public class SettingsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (profile != null){
            Glide.with(getContext()).load(profile.getUrl()).into(ivPostImage);
        } else {
            Log.i("TG", "Profile is null");
        }
    ...
    private void saveProfile(ParseUser currentUser, File photoFile) {
        ...
        currentUser.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                Toast.makeText(getContext(), "Profile was saved successfully!", Toast.LENGTH_LONG).show();
